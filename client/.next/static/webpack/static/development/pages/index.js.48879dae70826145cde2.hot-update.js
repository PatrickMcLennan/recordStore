...
function (_Component) {
  ...
  function Home() {
    ...
    Object(_babel_runtime_corejs2_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_8__["default"])(Object(_babel_runtime_corejs2_helpers_esm_assertThisInitialized__WEBPACK_IMPORTED_MODULE_6__["default"])(_this), "changePage", function (nextPage) {
      ...
      if (page && nextPage === 'store') {
        _this.setState({
          page: 'store'
        });
      } else if (page === nextPage && page !== 'store') {
        _this.setState({
          page: nextPage
        });
      }

      page === nextPage && nextPage !== 'store' ? page : _this.setState({
        page: nextPage
      });
    });
...
//# sourceMappingURL=index.js.48879dae70826145cde2.hot-update.js.map