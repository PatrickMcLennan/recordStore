  ...
  function Store() {
    ...
    function () {
      ...
      _babel_runtime_corejs2_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.mark(function _callee(id) {
        var _this$props, deleteRecord, user;

        return _babel_runtime_corejs2_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                _this$props = _this.props, deleteRecord = _this$props.deleteRecord, user = _this$props.user;
                _context.next = 3;
...
//# sourceMappingURL=index.js.89f61c76f17ef8f7b042.hot-update.js.map