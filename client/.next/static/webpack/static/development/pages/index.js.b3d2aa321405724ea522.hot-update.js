    ...
    return _babel_runtime_corejs2_regenerator__WEBPACK_IMPORTED_MODULE_1___default.a.wrap(function _callee7$(_context7) {
      while (1) {
        switch (_context7.prev = _context7.next) {
          case 0:
            _context7.next = 2;
            return users.doc(email).get().then(function (user) {
              return user.data();
            });

          case 2:
            getUser = _context7.sent;
            records = getUser.records.filter(function (record) {
              return record.id !== id;
            });
            console.log(records); // return await dbQuery(users, email);
...
//# sourceMappingURL=index.js.b3d2aa321405724ea522.hot-update.js.map