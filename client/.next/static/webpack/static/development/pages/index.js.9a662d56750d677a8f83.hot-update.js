...
})(["display:grid;grid-template-columns:minmax(100px,1fr) 1fr;grid-template-rows:200px;grid-row-gap:20px;div{grid-area:1 / 1 / 2 / 2;img{height:100%;width:100%;object-fit:contain;}}figcaption{grid-area:1 / 2 / 2 / 3;padding-left:1vw;", " position:relative;& > *{", "}p{text-transform:uppercase;align-self:center;text-align:center;font-size:2.5rem;font-weight:100;}p:last-of-type{text-align:left;font-style:italic;align-self:flex-start;font-weight:300;text-transform:uppercase;}}"], function (_ref) {
...
//# sourceMappingURL=index.js.9a662d56750d677a8f83.hot-update.js.map