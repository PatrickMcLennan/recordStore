...
})(["display:grid;grid-template-columns:repeat(auto-fit,minmax(550px,1fr));grid-gap:2vw;div{", ";align-self:stretch;text-align:center;border:1px solid red;h3{font-size:5rem;font-weight:100;margin-bottom:5vh;", "}p{font-size:2rem;margin-bottom:10vh;", "}div{", " ", "}}"], function (_ref) {
  var flexin = _ref.theme.flexin;
  return flexin('center', 'center', 'column');
}, _queries__WEBPACK_IMPORTED_MODULE_2__["default"], function (_ref2) {
...
//# sourceMappingURL=index.js.3af4fdeba0f25db2bfec.hot-update.js.map